...
func TestHandler_AddCardHandler(t *testing.T) {
	type mockBehavior func(s *mock_service.MockServices, requestData domain.NewCardData)

	testCases := []struct {
		name               string
		requestData        domain.NewCardData
	...
	}{
		{
			...
			mockBehavior: func(s *mock_service.MockServices, requestData domain.NewCardData) {
				s.EXPECT().AddCard(
...
func TestHandler_GetCardHandler(t *testing.T) {
	type mockBehavior func(s *mock_service.MockServices, requestData domain.CardData)

	testCases := []struct {
		name                 string
		requestData          domain.CardData
		mockBehavior         mockBehavior
		expectedStatusCode   int
	...
	}{
		{
			...
			mockBehavior: func(s *mock_service.MockServices, requestData domain.CardData) {
